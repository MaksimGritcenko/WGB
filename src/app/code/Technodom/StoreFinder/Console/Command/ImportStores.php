...
namespace Technodom\StoreFinder\Console\Command;
...
use Technodom\StoreFinder\Model\Import\StoreFinderImport;

/**
 * Class ImportStores
 *
 * @package Technodom\StoreFinder\Console\Command
 */
class ImportStores extends Command
{
    ...
    {
        $this->setName('technodom:import:storefinder')
